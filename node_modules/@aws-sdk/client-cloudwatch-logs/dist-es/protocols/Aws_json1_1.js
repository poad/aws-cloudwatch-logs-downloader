...
var serializeAws_json1_1MetricTransformation = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign({}, (input.defaultValue !== undefined &&
        input.defaultValue !== null && { defaultValue: __serializeFloat(input.defaultValue) })), (input.dimensions !== undefined &&
...
var serializeAws_json1_1PutDestinationPolicyRequest = function (input, context) {
    return __assign(__assign(__assign({}, (input.accessPolicy !== undefined && input.accessPolicy !== null && { accessPolicy: input.accessPolicy })), (input.destinationName !== undefined &&
        input.destinationName !== null && { destinationName: input.destinationName })), (input.forceUpdate !== undefined && input.forceUpdate !== null && { forceUpdate: input.forceUpdate }));
};
